...
export const store = mutation({
  ...
  handler: async (ctx) => {
    ...
    // Log the identity object to inspect its contents
    ...
    const userName = identity.name ?? identity.email ?? `User ${identity.tokenIdentifier.substring(0, 5)}`;
    console.log("Constructed user name:", userName);
